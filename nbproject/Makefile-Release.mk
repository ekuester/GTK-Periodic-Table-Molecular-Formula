...
${OBJECTDIR}/elementproperty.o: elementproperty.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elementproperty.o elementproperty.cpp

${OBJECTDIR}/elementschema.o: elementschema.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/elementschema.o elementschema.cpp
...
${OBJECTDIR}/molecularformula.o: molecularformula.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/molecularformula.o molecularformula.cpp

${OBJECTDIR}/periodictablewindow.o: periodictablewindow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/periodictablewindow.o periodictablewindow.cpp
